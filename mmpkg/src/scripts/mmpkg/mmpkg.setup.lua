...
function mmpkg.setup()
  ...
  mmpkg.events.startup = registerAnonymousEventHandler("sysWindowResizeEvent", "mmpkg.onResize")
  ...
  if not mmpkg.conf.tabs then
    mmpkg.conf.tabs = {"All", "Alliance", "Clan", "Novice", "Tells", "Form", "Relays", "Talk"}
  end
...
background-color: black;
  ...
  GUI.Right = Geyser.Label:new({name = "GUI.Right", x = "-40%", y = 0, width = "40%", height = "100%"})
  GUI.Right:setStyleSheet(GUI.BackgroundCSS:getCSS())
  GUI.XPbar = Geyser.Container:new({name = "GUI.XPbar", x = 0, y = -25, width = "60%", height = 20, color = "white"})
  GUI.XPgauge =
    demonnic.iGauge:new(
    {
      name = "GUI.XPgauge",
  ...
  GUI.VitalBars = Geyser.Container:new({name = "GUI.VitalBars", x = 0, y = -50, width = "60%", height = 20})
  GUI.HPmain = Geyser.Container:new({name = "GUI.HPMain", x = 0, y = 0, width = "33%", height = "100%"}, GUI.VitalBars)
  GUI.SPmain =
    Geyser.Container:new({name = "GUI.SPMain", x = "33%", y = 0, width = "33%", height = "100%"}, GUI.VitalBars)
  GUI.STmain =
    Geyser.Container:new({name = "GUI.STMain", x = "66%", y = 0, width = "33%", height = "100%"}, GUI.VitalBars)
  GUI.Health =
    demonnic.iGauge:new(
    {
      name = "GUI.Health",
...
margin: 10px;
  ...
  GUI.Box1 = Geyser.Label:new({name = "GUI.Box1", x = 0, y = 0, width = "100%", height = "50%"}, GUI.Right)
  GUI.Box1:setStyleSheet(GUI.BoxCSS:getCSS())
  GUI.vmap_container =
    Geyser.Container:new({name = "GUI.vmap_container", x = 0, y = 0, width = "100%", height = "100%"}, GUI.Box1)
  GUI.vmapper = Geyser.Label:new({name = "GUI.vmapper", x = 20, y = 20, width = -20, height = -20}, GUI.vmap_container)
  GUI.vmapper:setStyleSheet([[border-image: url(]] .. mmpkg.mapimg .. [[);]])
  GUI.Map_Container =
    Geyser.Container:new({name = "GUI.Map_Container", x = 0, y = 0, width = "100%", height = "100%"}, GUI.Box1)
  GUI.Mapper = Geyser.Mapper:new({name = "GUI.Mapper", x = 20, y = 55, width = -20, height = -20}, GUI.Map_Container)
  GUI.MapInfo =
    Geyser.Label:new(
    {name = "GUI.MapInfo", x = 20, y = 20, width = -20, height = "35", fgColor = "black"},
    GUI.Map_Container
  )
...
background-color: rgba(66,198,198,100%);
  ...
  GUI.Box2 = Geyser.Label:new({name = "GUI.Box2", x = 0, y = "50%", width = "100%", height = "50%"}, GUI.Right)
...
function demonnic.iGauge:new(cons, container)
  ...
  self.__index = self
  me.back = Geyser.Label:new({name = me.name .. "_back", x = 0, y = 0, width = "100%", height = "100%"}, me)
  me.front = Geyser.Label:new({name = me.name .. "_front", x = 0, y = 0, width = "100%", height = "100%"}, me.back)
    ...
    function()
      ...
      cecho(
        "<red>ERROR! Expected room #:<white> " ..
          speedWalkPath[1] .. "<red> But we're stuck in room #:<white> " .. mmpkg.currentRoom.ID
      )
    end
  )
end
