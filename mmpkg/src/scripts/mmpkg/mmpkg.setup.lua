...
function mmpkg.setup()
    ...
    mmpkg.events.newroom = registerAnonymousEventHandler("mmpkg.onNewRoom",
                                                         "mmpkg.isNewRoom")
    mmpkg.events.newzone = registerAnonymousEventHandler("mmpkg.onNewZone",
                                                         "mmpkg.isNewZone")
    mmpkg.events.qtimerevent = registerAnonymousEventHandler(
                                   "mmpkg.OnQuestTimer", "mmpkg.isQuestTimer")
    mmpkg.events.imdead = registerAnonymousEventHandler("mmpkg.OnDeath",
                                                        "mmpkg.isDead")
    mmpkg.events.imalive = registerAnonymousEventHandler("mmpkg.OnAlive",
                                                         "mmpkg.isAlive")
    mmpkg.events.onclose = registerAnonymousEventHandler("sysExitEvent",
                                                         "mmpkg.onClose")
    mmpkg.events.startup = registerAnonymousEventHandler("sysWindowResizeEvent",
                                                         "mmpkg.onResize")
    mmpkg.events.mapping = registerAnonymousEventHandler("gmcp.room.info",
                                                         "mapping")
    mmpkg.events.updvitals = registerAnonymousEventHandler("gmcp.char.vitals",
                                                           "mmpkg.updateVitals")
    mmpkg.events.updmax = registerAnonymousEventHandler("gmcp.char.maxstats",
                                                        "mmpkg.updateMaxStats")
    mmpkg.events.updxp = registerAnonymousEventHandler("gmcp.char.status",
                                                       "mmpkg.updateXP")
    mmpkg.events.charname = registerAnonymousEventHandler("gmcp.char.base.name",
                                                          "mmpkg.updateCharName")
    mmpkg.events.uninstall = registerAnonymousEventHandler(
                                 "sysUninstallPackage", "mmpkg_Uninstalled")
...
function mmpkg.onClose() table.save(mmpkg.resources .. "/mmpkg.conf", mmpkg.conf) end
...
function CSSMan:set(key, value) self.stylesheet[key] = value end

function CSSMan:get(key) return self.stylesheet[key] end
...
function CSSMan:gettable() return self.stylesheet end
